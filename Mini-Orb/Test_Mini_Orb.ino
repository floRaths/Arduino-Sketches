...
DEFINE_GRADIENT_PALETTE( pit ) {
  0, 0, 0, 0,
  28,   100, 0,   103, // purple
  56,   101, 48,193, // light purple
  84, 0, 0, 0,
  112,   94,  100,204,// light blue 
  140,  0,96,99, //  tuquoise
  168,  72,209,204, // light turquoise
  196, 0, 0, 0,
  224,  255, 130, 3, // orange
  255,  225, 94, 0 // orange
...
void noise_noise1() {
  ...
  scale_x[0] = 1000 + (noise[0][0][CentreY] * 16);
